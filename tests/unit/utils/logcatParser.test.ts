 ...
 */
import { parseLogcatLine, formatLogcatLine, LogLevel } from '../../../src/utils/logcatParser';
...
describe('logcatParser', () => {
    describe('parseLogcatLine', () => {
        ...
        it('should handle verbose level', () => {
            ...
            expect(result?.level).toBe(LogLevel.VERBOSE);
        });
    ...
    describe('formatLogcatLine', () => {
        ...
        it('should handle missing timestamp', () => {
            ...
            const formatted = formatLogcatLine(logLine, false, false, false);
